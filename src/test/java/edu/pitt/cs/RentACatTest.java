...
public class RentACatTest {
	...
	public void setUp() throws Exception {
		...
		// Uncomment to test the unit tests themselves
	...
	public void testCatAvailableTrueNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		// No need to stub c1's or c2's getRented because they return false by default
	...
	public void testCatAvailableFalseNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		// No need to stub c1's or c3's getRented because they return false by default
